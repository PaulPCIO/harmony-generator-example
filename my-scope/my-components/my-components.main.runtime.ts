...
import { MyComponentsAspect } from './my-components.aspect';

export class MyComponentsMain {
  static slots = [];
...
`,
    ...
    return new MyComponentsMain();
  }
}

MyComponentsAspect.addRuntime(MyComponentsMain);
